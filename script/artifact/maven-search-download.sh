...
OBJECT_PATH="$GROUP_PATH/$NEXUS_OBJECT_ARTIFACT_ID/$NEXUS_OBJECT_VERSION/$NEXUS_OBJECT_ARTIFACT_ID-$NEXUS_OBJECT_VERSION-$NEXUS_OBJECT_CLASSIFIER.$NEXUS_OBJECT_EXTENSION"
OBJECT_PATH_SHA1="$GROUP_PATH/$NEXUS_OBJECT_ARTIFACT_ID/$NEXUS_OBJECT_VERSION/$NEXUS_OBJECT_ARTIFACT_ID-$NEXUS_OBJECT_VERSION-$NEXUS_OBJECT_CLASSIFIER.$NEXUS_OBJECT_EXTENSION.sha1"
