...
SONATYPE_API="service/local/artifact/maven/content?r=central-proxy&g=$NEXUS_OBJECT_GROUP_ID&a=$NEXUS_OBJECT_ARTIFACT_ID&e=$NEXUS_OBJECT_EXTENSION$QUERY_PARAM_CLASSIFIER&v=$NEXUS_OBJECT_VERSION";
echo "SONATYPE_API=$SONATYPE_API"
SONATYPE_API_SHA1="service/local/artifact/maven/content?r=central-proxy&g=$NEXUS_OBJECT_GROUP_ID&a=$NEXUS_OBJECT_ARTIFACT_ID$QUERY_PARAM_CLASSIFIER&e=$NEXUS_OBJECT_EXTENSION.sha1&v=$NEXUS_OBJECT_VERSION";
